...
public class PTra13_09 {
	...
	public static void main(String[] args) {
		...
		for (int j = 0; j < employees.length; j++) {
			System.out.println(employees[j].getUserNm());
			System.out.println(employees[j].getMail());
			System.out.println(employees[j].getPassword());
			System.out.println(employees[j].getDepartmentNm());
			System.out.println(employees[j].getDepartmentCnt());
		}
